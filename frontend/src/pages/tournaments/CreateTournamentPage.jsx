...
import { 
  ArrowLeft, Trophy, Users, Clock, Calendar,
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">{formData.maxParticipants}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">
                          {new Date(`${formData.startDate}T${formData.startTime}`).toLocaleString('vi-VN')}
                        </span>
                      </div>
                      <div className="flex justify-between">
