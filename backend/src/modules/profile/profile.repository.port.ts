...
export interface ProfileRepositoryPort {
  ...
  updatePasswordHashByUserId(userId: string, passwordHash: string, now: Date): Promise<boolean>
  updateUserAvatarById(userId: string, avatar: { avatarUrl: string; avatarPublicId: string | null; now: Date }): Promise<UserProfileDoc | null>
